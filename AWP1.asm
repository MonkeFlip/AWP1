...
PUBLIC	??_C@_08EOAODLEH@Matrix1?3@			; `string'
PUBLIC	??_C@_08EMEIIFBO@Matrix2?3@			; `string'
...
CONST	ENDS
;	COMDAT ??_C@_08EMEIIFBO@Matrix2?3@
CONST	SEGMENT
??_C@_08EMEIIFBO@Matrix2?3@ DB 'Matrix2:', 00H		; `string'
CONST	ENDS
;	COMDAT ??_C@_08EOAODLEH@Matrix1?3@
CONST	SEGMENT
??_C@_08EOAODLEH@Matrix1?3@ DB 'Matrix1:', 00H		; `string'
CONST	ENDS
...
PUBLIC	?DisplayMatrix@@YAXPEAPEAPEAPEAMHH@Z		; DisplayMatrix
...
;	COMDAT pdata
pdata	SEGMENT
$pdata$?FillMatrix@@YAXPEAPEAPEAPEAMHH@Z DD imagerel $LN34@FillMatrix
	DD	imagerel $LN34@FillMatrix+145
	DD	imagerel $unwind$?FillMatrix@@YAXPEAPEAPEAPEAMHH@Z
pdata	ENDS
;	COMDAT pdata
pdata	SEGMENT
$pdata$?DisplayMatrix@@YAXPEAPEAPEAPEAMHH@Z DD imagerel $LN32@DisplayMat
	DD	imagerel $LN32@DisplayMat+211
	DD	imagerel $unwind$?DisplayMatrix@@YAXPEAPEAPEAPEAMHH@Z
pdata	ENDS
;	COMDAT pdata
pdata	SEGMENT
...
;	COMDAT xdata
xdata	SEGMENT
$unwind$?DisplayMatrix@@YAXPEAPEAPEAPEAMHH@Z DQ 0000b741e000c1e01r ; 1.59282e-308
...
;	COMDAT xdata
xdata	SEGMENT
$unwind$?FillMatrix@@YAXPEAPEAPEAPEAMHH@Z DQ 00002740a00040a01r ; 3.4117e-309
	DD	013405H
xdata	ENDS
;	COMDAT xdata
xdata	SEGMENT
...
; Line 141
	...
	lea	rdx, OFFSET FLAT:??_C@_08EOAODLEH@Matrix1?3@
...
; Line 142
	...
	mov	rcx, r12
	call	?DisplayMatrix@@YAXPEAPEAPEAPEAMHH@Z	; DisplayMatrix
; Line 143
	mov	rcx, QWORD PTR __imp_?cout@std@@3V?$basic_ostream@DU?$char_traits@D@std@@@1@A
	lea	rdx, OFFSET FLAT:??_C@_08EMEIIFBO@Matrix2?3@
	call	??$?6U?$char_traits@D@std@@@std@@YAAEAV?$basic_ostream@DU?$char_traits@D@std@@@0@AEAV10@PEBD@Z ; std::operator<<<std::char_traits<char> >
	mov	rcx, rax
	lea	rdx, OFFSET FLAT:??$endl@DU?$char_traits@D@std@@@std@@YAAEAV?$basic_ostream@DU?$char_traits@D@std@@@0@AEAV10@@Z ; std::endl<char,std::char_traits<char> >
	call	QWORD PTR __imp_??6?$basic_ostream@DU?$char_traits@D@std@@@std@@QEAAAEAV01@P6AAEAV01@AEAV01@@Z@Z
; Line 144
	mov	r8d, DWORD PTR ?y_matrix2@@3HA		; y_matrix2
	mov	rcx, rsi
...
; Line 151
	add	r15, 8
	cmp	r15, 32					; 00000020H
	jl	$LL46@main
; Line 149
	add	r12, 8
	sub	QWORD PTR tv9660[rsp], 1
	jne	$LL43@main
; File C:\Program Files\Microsoft Visual Studio\2022\Community\VC\Tools\MSVC\14.30.30705\include\chrono
; Line 691
	call	QWORD PTR __imp__Query_perf_frequency
...
; Line 163
	...
	mov	r8d, DWORD PTR ?y_result@@3HA		; y_result
	mov	rcx, r13
	mov	edx, DWORD PTR ?x_result@@3HA		; x_result
	call	?DisplayMatrix@@YAXPEAPEAPEAPEAMHH@Z	; DisplayMatrix
; Line 328
...
; Line 701
	add	rbx, rcx
	mov	QWORD PTR tv9505[rsp], rax
	mov	QWORD PTR t1$2$[rsp], rbx
	npad	1
$LL52@main:
	mov	rcx, QWORD PTR $T86[rsp]
...
; Line 169
	xor	r11d, r11d
	mov	QWORD PTR tv9613[rsp], rcx
	mov	QWORD PTR tv9507[rsp], r11
	mov	QWORD PTR tv9612[rsp], rax
	npad	4
$LL55@main:
; Line 171
	mov	rsi, QWORD PTR $T88[rsp]
	mov	rdx, rcx
	mov	QWORD PTR tv9510[rsp], rcx
	mov	QWORD PTR tv9511[rsp], 4
	npad	7
$LL58@main:
; Line 173
...
; Line 222
	...
	jne	$LL168@main
; Line 274
	mov	r11, QWORD PTR tv9507[rsp]
	xor	r10d, r10d
	mov	rax, QWORD PTR tv9612[rsp]
	mov	rsi, QWORD PTR $T88[rsp]
...
$LN56@main:
; Line 171
	mov	rdx, QWORD PTR tv9510[rsp]
	add	rdx, 8
	sub	QWORD PTR tv9511[rsp], 1
	mov	QWORD PTR tv9510[rsp], rdx
	jne	$LL58@main
; Line 169
	mov	rcx, QWORD PTR tv9613[rsp]
	add	r11, 8
	mov	QWORD PTR tv9507[rsp], r11
	cmp	r11, 32					; 00000020H
	jl	$LL55@main
; Line 167
	mov	rax, QWORD PTR tv9505[rsp]
	add	rax, 8
	sub	QWORD PTR tv9506[rsp], 1
	mov	QWORD PTR tv9505[rsp], rax
	jne	$LL52@main
; File C:\Program Files\Microsoft Visual Studio\2022\Community\VC\Tools\MSVC\14.30.30705\include\chrono
; Line 691
...
; Line 700
	...
	cdq
	idiv	rdi
	mov	rdi, QWORD PTR $T89[rsp]
	imul	rcx, rax, 1000000000			; 3b9aca00H
	mov	QWORD PTR tv9593[rsp], rdi
; Line 701
	add	rbx, rcx
